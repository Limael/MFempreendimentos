  ...
  const drawerList = (
    ...
    >
      ...
      >
        ...
        <List sx={{ mt: 2 }}>
          <ListItemButton onClick={openAboutUsModal}>
            <ListItemText primary="Sobre nós" />
          </ListItemButton>
          <ListItemButton onClick={() => scrollToRef(houseProjectsRef)}>
            <ListItemText primary="Incorporação" />
          </ListItemButton>
          <ListItemButton onClick={() => scrollToRef(projectsRef)}>
      ...
      <Box display="flex" justifyContent="center" mb={2}>
        <IconButton
          sx={{ color: "white" }}
          href="https://www.facebook.com/mf.incorporadora/"
          target="_blank"
        >
          <img
            src={facebook}
        ...
        <IconButton
          sx={{ color: "white" }}
          href="https://www.instagram.com/mf.empreendimentos/"
          target="_blank"
        >
          <img
            src={instagram}
        ...
        <Container>
          <Toolbar disableGutters sx={{ justifyContent: "space-between" }}>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" }, gap: 4 }}>
              ...
              <Button
                onClick={() => scrollToRef(houseProjectsRef)}
                sx={{
                  color: "white",
                  fontFamily: "Inter",
                  fontSize: ".85rem",
