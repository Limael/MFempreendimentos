    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="xl" sx={{ p: 0 }}>
            <DialogContent sx={{ p: 0, display: 'flex', justifyContent: 'center', alignItems: 'stretch', backgroundColor: '#111', color: 'white' }}>
                {project && (
                    <Grid container sx={{ padding: '0px' }} display={'flex'} alignItems={'center'}>
                        <Grid item xs={12} md={6} sx={{ position: 'relative', height: '80%!important' }}>
                            <Box
                                sx={{
                            ...
                            >
                                ...
                                <Typography variant="h5" sx={{ padding: '20px 0', fontWeight: 600, mb: 2 }}>
                                    {project.title}
                                </Typography>
                                        ...
                                        >
                                            <Box
                                                ...
                                                sx={{
                                                    ...
                                                    objectFit: 'cover',
                                                    objectPosition: 'center',
                                                    border: selectedImage === project.images[imageKey].default ? '2px solid white' : '2px solid transparent',
                                                }}
                                            />
                                        </Box>
                                    ))}
