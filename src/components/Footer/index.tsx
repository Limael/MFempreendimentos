...
const footerInfo = {
  ...
  phone: {
    title: "Telefone",
    content: ["(45) 99129-1013", "(45) 99932-1981"],
  },
  social: {
    title: "Redes sociais",
    links: [
      {
        name: "@mf.empreendimentos",
        url: "https://www.instagram.com/mf.empreendimentos/",
      },
    ],
  },
};
      ...
      <Grid container spacing={4} justifyContent="space-evenly" px={12}>
        ...
        <Grid item xs={12} sm={6} md={4.4}>
          ...
          >
            <Link
              target="_blank"
              sx={{ textDecoration: "none", color: "#252626" }}
              href={footerInfo.email.link}
            >
              {footerInfo.email.content}
            </Link>
          </Typography>
        </Grid>
